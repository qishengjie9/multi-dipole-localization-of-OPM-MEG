...
G1 = G1.G;
G2 = load('SPMgainmatrix_1pos_1_snr_10sim_opm_30mm_pos_1_1.mat');
G2 = G2.G;
G3 = load('SPMgainmatrix_2pos_1_snr_10sim_opm_30mm_pos_2_1.mat');
G3 = G3.G;
G4 = load('SPMgainmatrix_3pos_1_snr_10sim_opm_30mm_pos_3_1.mat');
G4 = G4.G;
G5 = load('SPMgainmatrix_4pos_1_snr_10sim_opm_30mm_pos_4_1.mat');
G5 = G5.G;
G6 = load('SPMgainmatrix_5pos_1_snr_10sim_opm_30mm_pos_5_1.mat');
G6 = G6.G;
...
poserr_500result_5S = zeros(2,3,length(SNR_range),MC_repetitions,Nerror_pos);
...
%           % AP-wMUSIC 
            ...
            poserr_500result_5S(1,1,SNRindex,i,JJ) = mean(d_AP);
            poserr_500result_5S(2,1,SNRindex,i,JJ) = calculate_RMSE(S,Gain_err,Msnr,S_AP,index_AP);
...
save('poserr_500result_5S.mat','poserr_500result_5S');
...
pos_range = [0 1 2 3 4 5];
Nerror_pos = length(pos_range);
poserr_500result_5S_corr1 = zeros(2,3,length(SNR_range),MC_repetitions,Nerror_pos);
% 2 stands for two evaluation metrics; 3 for the three inverse solutions
%ap_gain_result{1,1} =  aTdist_AP;
...
%           % AP-wMUSIC 
            ...
            poserr_500result_5S_corr1(1,1,SNRindex,i,JJ) = mean(d_AP);
            poserr_500result_5S_corr1(2,1,SNRindex,i,JJ) = calculate_RMSE(S,Gain_err,Msnr,S_AP,index_AP);
            poserr_500result_5S_corr1(1,2,SNRindex,i,JJ) = mean(d_ISW);
            poserr_500result_5S_corr1(2,2,SNRindex,i,JJ) = calculate_RMSE(S,Gain_err,Msnr,S_AP_W_MUSIC,index_ISW);
            poserr_500result_5S_corr1(1,3,SNRindex,i,JJ) = mean(d_APM);
            poserr_500result_5S_corr1(2,3,SNRindex,i,JJ) = calculate_RMSE(S,Gain_err,Msnr,S_AP_MUSIC,index_APM);
            
        end

    end
end
save('poserr_500result_5S_corr1.mat','poserr_500result_5S_corr1');