...
G1 = G1.G;
G2 = load('template_array/SPMgainmatrix_Temp_angular1Temp_dualsim_opm_30mm_1.mat');
G2 = G2.G;
G3 = load('template_array/SPMgainmatrix_Temp_angular2Temp_dualsim_opm_30mm_1.mat');
G3 = G3.G;
G4 = load('template_array/SPMgainmatrix_Temp_angular3Temp_dualsim_opm_30mm_1.mat');
G4 = G4.G;
G5 = load('template_array/SPMgainmatrix_Temp_angular4Temp_dualsim_opm_30mm_1.mat');
G5 = G5.G;
G6 = load('template_array/SPMgainmatrix_Temp_angular5Temp_dualsim_opm_30mm_1.mat');
G6 = G6.G;
...
%SNR_range = -10:10; % dB
angular_range = [0 2 4 6 8 10];
Nerror_angular = length(angular_range);
angularerr_dual_2S_corr1 = zeros(2,3,length(SNR_range),MC_repetitions,Nerror_angular);
...
%                 [d_APM(s), index_APM(s)] = min(dist_APM);
            ...
            angularerr_dual_2S_corr1(1,1,SNRindex,i,JJ) = mean(d_AP);
            angularerr_dual_2S_corr1(2,1,SNRindex,i,JJ) = calculate_RMSE(S,Gain_err,Msnr,S_AP,index_AP);
...
save('angularerr_dual_2S_corr1.mat','angularerr_dual_2S_corr1');
...
angular_range = [0 2 4 6 8 10];
Nerror_angular = length(angular_range);
angularerr_dual_5S_corr1 = zeros(2,3,length(SNR_range),MC_repetitions,Nerror_angular);
% 2 stands for two evaluation metrics; 3 for the three inverse solutions
%ap_gain_result{1,1} =  aTdist_AP;
...
%                 [d_APM(s), index_APM(s)] = min(dist_APM);
            ...
            angularerr_dual_5S_corr1(1,1,SNRindex,i,JJ) = mean(d_AP);
            angularerr_dual_5S_corr1(2,1,SNRindex,i,JJ) = calculate_RMSE(S,Gain_err,Msnr,S_AP,index_AP);
%             angularerr_500result_5S_corr1(1,2,SNRindex,i,JJ) = mean(d_ISW);
%             angularerr_500result_5S_corr1(2,2,SNRindex,i,JJ) = calculate_RMSE(S,Gain_err,Msnr,S_AP_W_MUSIC,index_ISW);
%             angularerr_500result_5S_corr1(1,3,SNRindex,i,JJ) = mean(d_APM);
%             angularerr_500result_5S_corr1(2,3,SNRindex,i,JJ) = calculate_RMSE(S,Gain_err,Msnr,S_AP_MUSIC,index_APM);
...
save('angularerr_dual_5S_corr1.mat','angularerr_dual_5S_corr1');
